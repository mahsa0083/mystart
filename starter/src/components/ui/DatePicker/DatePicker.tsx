    ...
    (props, ref) => {
        ...
        const [inputState, setInputState] = useState(
            _value instanceof Date
                ? capitalize(
                    moment(_value).locale('fa').format(dateFormat),
                )
                : ''
        );
        const closeDropdown = () => {
        ...
        useEffect(() => {
            ...
            if (value instanceof Date && !focused) {
                setInputState(
                    capitalize(
                        moment(value).locale('fa').format(dateFormat),
                    ),
                )
            }
            // eslint-disable-next-line react-hooks/exhaustive-deps
        ...
        const handleValueChange = (date: Date | null) => {
            ...
            if (date) {
                ...
                setInputState(
                    capitalize(moment(date).locale('fa').format(dateFormat)),
                );
            }
        ...
        const setDateFromInput = () => {
            ...
            if (dayjs(date).isValid()) {
                ...
                if (date) {
                    setInputState(
                        capitalize(
                            moment(date).locale('fa').format(dateFormat),
                        ),
                    )
                }
